<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="editnote.aspx.vb" Inherits="Asp_Project.editnote" %>
...
<body lang="ko-kr">
    ...
    <section id="contents" class ="row">
        ...
        <form id="form1" runat="server" class="align">
            ...
            <br />
            <asp:Button ID="deletelist" runat="server" Text="선택한 단어장 삭제" Width="220px" />
            <br />
            <br />
        </form>
        </div>
